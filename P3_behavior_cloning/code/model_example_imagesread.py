...
centerImgs = np.array([loadImg(imgLoc, True) for imgLoc in drivingLog['Center'][1:numSample]], dtype=np.float32)
leftImgs = np.array([loadImg(imgLoc, True) for imgLoc in drivingLog['Left'][1:numSample]], dtype=np.float32)
rightImgs = np.array([loadImg(imgLoc, True) for imgLoc in drivingLog['Right'][1:numSample]], dtype=np.float32)
